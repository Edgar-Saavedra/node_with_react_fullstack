...
- Mongoose.js :
  - to make our lives easier working with MONGODB
  - Wraps up common operations for mongo.
- How mongo stores info:
  - stores in to collections
    - collections have records
    - records can have collections
    - EXAMPLE:
      - User collection:
        - Each record is JSON.
        - Key/Value
        - A user might have keys like, id, name, height
  - Schemaless
    - Records in collections can have varying keys
    - in contrast to Relational DBs
- Mongoose in relation to MongoDB
  - Mongoose has:
    - Model Clase = Collection
